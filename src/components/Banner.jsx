      ...
      <div className="hero-content flex-col xl:gap-96 lg:flex-row-reverse ">
        <div className="flex-1">
          ...
          <motion.img
            ...
            transition={{duration:10, repeat:Infinity}}
            className="max-w-sm rounded-xl hidden md:block shadow-2xl size-60"   
          />
        </div>
        <div className="flex-1">
          <motion.h1 animate={{x:[0,50,0]}}  transition={{ duration: 4, delay: 1, ease: "linear",repeat:Infinity }} className="text-5xl text-blue-500 font-bold">Find Your Desired Book Here.</motion.h1>
