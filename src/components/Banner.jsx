  ...
  return (
    <div className="hero bg-base-200 my-10">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="flex-1">
          <motion.h1 animate={{x:[0,50,0]}}  transition={{ duration: 4, delay: 1, ease: "linear",repeat:Infinity }} className="text-5xl font-bold">Find Your Desired Book Here.</motion.h1>
